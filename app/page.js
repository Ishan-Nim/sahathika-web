  ...
  return (
    <header className="topbar">
      <div className="topbar__inner">
        <button className="brand brand--logo brand-button" id="homeTrigger" onClick={onHome} type="button">
          <img src={brandAssets.headerLogo.src} alt="Accredible Credential.net" height="32" className="brand__image" />
        </button>
        <nav className="topbar__nav" aria-label="Primary">
          <a href="https://v2.accounts.accredible.com/sign-in">Suggested Credentials</a>
          <a href="https://v2.accounts.accredible.com/sign-in">Career Journey</a>
          <a className="signin" href="https://v2.accounts.accredible.com/sign-in">
...
function renderIssuerBadge(credential) {
  ...
  if (!logo) {
    return <span>{credential.issuerShort}</span>;
  }
...
function CredentialCard({ credential, onOpen }) {
  return (
    <button className="credential-card" type="button" onClick={() => onOpen(credential)}>
      ...
      <section className="list-layout view-section" aria-labelledby="credentialsHeading">
        <div className="content-width">
          <article className="insight-banner">
            ...
            <a className="ghost-button" href="https://v2.accounts.accredible.com/sign-in">
              Sign In
            </a>
          </article>

          <h2 className="sr-only" id="credentialsHeading">
            Credentials
          </h2>
...
function DetailView({ credential, onBack }) {
          ...
          <div className="content-width detail-hero__inner">
            <div className="detail-gallery">
              <div className="detail-gallery__thumbs">
                <button className={`thumb-card ${galleryState === "card" ? "is-active" : ""}`} type="button" onClick={() => setGalleryState("card")}>
                  <div className="credential-art credential-art--image">
                    <img src={credential.certImg.src} alt={`${credential.shortCode} cert`} />
                  </div>
                </button>
                <button className={`thumb-card ${galleryState === "badge" ? "is-active" : ""}`} type="button" onClick={() => setGalleryState("badge")}>
                  <div className="credential-art credential-art--image">
        ...
        <div className="content-width detail-content">
          <section className="detail-main">
            ...
            <div className="action-row">
              <div className="action-drop">
                <button className="action-btn" type="button" onClick={() => setShowDownload((value) => !value)}>
                ...
                {showDownload ? (
                  <div className="action-drop__menu">
                    ...
                    <a className="drop-item" href={credential.certImg.src} download={certDownloadName}>
                      <span>JSON</span>
                      <span className="drop-item__sub">Open Badge 3.0</span>
                    </a>
                    <a className="drop-item" href={credential.certImg.src} download={certDownloadName}>
                      <span>JSON</span>
                      <span className="drop-item__sub">W3C Verified Credential</span>
                    </a>
              ...
              <div className="action-drop">
                <button className="action-btn" type="button" onClick={() => setShowMore((value) => !value)}>
            ...
            <a className="subtle-link" href="https://v2.accounts.accredible.com/sign-in">
            ...
            <div className="recipient-block">
              ...
              <div>
                ...
                <div className="recipient-links">
                  ...
                  <a href="https://www.linkedin.com/in/ishannim/" target="_blank" rel="noopener noreferrer">
                    LinkedIn
                  </a>
                  <a href="https://x.com/d4rkelves" target="_blank" rel="noopener noreferrer">
                    X
                  </a>
                </div>
              </div>
          ...
          <aside className="detail-sidebar">
            <article className="value-panel">
              ...
              <a className="value-panel__button" href={credential.careerJourneyUrl || "#"} target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <article className="sidebar-card">
              ...
              <ul className="verify-list">
                ...
                <li>
                  Secured by Blockchain <span className="copy-id">Copy ID</span>
                </li>
              </ul>
        ...
        <div className="footer-top">
          ...
          <div className="footer-language">
            <label className="language-picker" htmlFor="languageSelect">
              <span>Language:</span>
              <select id="languageSelect" aria-label="Language selector" value={language} onChange={(event) => setLanguage(event.target.value)}>
                {languages.map((item) => (
...
export default function Page() {
  ...
  const content = useMemo(() => {
    if (view === "detail") {
      return <DetailView credential={selectedCredential} onBack={() => setView("list")} />;
    }
    return (
      <WalletView
        onOpen={(credential) => {
  ...
  }, [selectedCredential, view]);

  return (
    <div className="page-shell">
      <Header onHome={() => setView("list")} />
      <main>{content}</main>
